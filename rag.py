...
prompt = ChatPromptTemplate.from_messages(
    [
        ("system",
         ...
         Kullanıcının sorusunu sadece sana verilen context içerisindeli bilgileri kullanarak cevappla.
         context içerisinde cevap bulunmuyorsa: "Bu bilgi dökümanda bulunmuyor" şeklinde cevap ver
         """
         ),
         ("human",
          """CONTEXT: {context}
