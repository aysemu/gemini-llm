...
def general_question_tool(question:str) -> str:
    """
    Genel bilgi,günlük yaşam,yazılım,teknoloji,yemek,eğitim ve MIL-STD teknik dökümanıyla ilgili olmayan 
...
def mil_std_rag_tool(question: str) -> str:
    """
    RKT-MIL-STD-001 dokümanına dayalı soruları cevaplamak için kullanılır.
    Çalışma sıcaklığı,depolama sıcaklığı,nem,titreşim,mekanik şok, rakım, güç gereksinimleri ve tesst kriterleri
    gibi teknik dökman sorularına bu toll kullanılmalıdır.
    """
